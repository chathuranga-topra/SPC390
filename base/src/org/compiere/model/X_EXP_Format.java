...
public class X_EXP_Format extends PO implements I_EXP_Format, I_Persistent 
{
	...
	/** Set UseForExport.
		@param IsUseForExport UseForExport	  */
	public void setIsUseForExport (boolean IsUseForExport)
	{
		set_Value (COLUMNNAME_IsUseForExport, Boolean.valueOf(IsUseForExport));
	}

	/** Get UseForExport.
		@return UseForExport	  */
	public boolean isUseForExport () 
	{
		Object oo = get_Value(COLUMNNAME_IsUseForExport);
		if (oo != null) 
		{
	...
	/** Set UseForImport.
		@param IsUseForImport UseForImport	  */
	public void setIsUseForImport (boolean IsUseForImport)
	{
		set_Value (COLUMNNAME_IsUseForImport, Boolean.valueOf(IsUseForImport));
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_IsUseForImport);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	/** Set ValidateOrg.
		@param IsValidateOrg ValidateOrg	  */
	public void setIsValidateOrg (boolean IsValidateOrg)
	{
		set_Value (COLUMNNAME_IsValidateOrg, Boolean.valueOf(IsValidateOrg));
	}

	/** Get ValidateOrg.
		@return ValidateOrg	  */
	public boolean isValidateOrg () 
	{
		Object oo = get_Value(COLUMNNAME_IsValidateOrg);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
